...
<div id="footer_info_w" class="footer_info_w">
    ...
    <div class="sp2_area">
        <h5 class="col-lg-12 col-sm-12" style="line-height:50px;white-space: nowrap;align-items: center;display: flex; font-weight: 700;">ORGANIZED BY</h5>
    ...
    <div class="sp2_area">
        <h5 class="col-lg-12 col-sm-12" style="line-height:50px;white-space: nowrap;align-items: center;display: flex; font-weight: 700;">CO-ORGANIZED BY</h5>
        <ul class="col-lg-12 col-sm-12">
    ...
    <div class="sp2_area">
        <h5 class="col-lg-12 col-sm-12" style="line-height:50px;white-space: nowrap;align-items: center;display: flex; font-weight: 700;">ADVISED BY</h5>
        <ul class="col-lg-12 col-sm-12">
            <li><a href="https://www.nstc.gov.tw//" target="_blank"><img src="images/agencies/NSTC.png"></a></li>
        </ul>
    </div>
    <div class="sp2_area">
        <h5 class="col-lg-12 col-sm-12" style="line-height:50px;white-space: nowrap;align-items: center;display: flex; font-weight: 700;">DIAMOND SPONSORS</h5>
        <ul class="col-lg-12 col-sm-12">
    ...
    <div class="sp2_area">
        <h5 class="col-lg-12 col-sm-12" style="line-height:50px;white-space: nowrap;align-items: center;display: flex; font-weight: 700;">GOLD SPONSORS</h5>
        <ul class="col-lg-12 col-sm-12">
			...
			<li><a href="https://tws.twcc.ai/" target="_blank"><img src="images/agencies/Sino.jpg"/></a></li><br/>
			<li><a href="https://tws.twcc.ai/" target="_blank"><img src="images/agencies/Appier-logo_blue.png"/></a></li><br/>
        </ul>
    </div>
    </div>
</div>
