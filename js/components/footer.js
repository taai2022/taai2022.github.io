...
<div id="footer_info_w" class="footer_info_w">
    ...
    <div class="sp2_area">
        <strong class="col-lg-2" col-sm-2 style="line-height:50px;white-space: nowrap;align-items: center;display: flex;">ORGANIZED BY</strong>
        <ul class="col-lg-10 col-sm-10">
            <li><a href="http://www.ncku.edu.tw/" target="_blank"><img src="images/agencies/NCKU.jpg"></a></li>
            <li><a href="http://www.taai.org.tw/" target="_blank"><img src="images/agencies/TAAI.png"></a></li>
        </ul>
    </div>
    <div class="sp2_area">
        <strong class="col-lg-2 col-sm-2" style="line-height:50px;white-space: nowrap;align-items: center;display: flex;">CO-ORGANIZED BY</strong>
        <ul class="col-lg-10 col-sm-10">
    ...
    <div class="sp2_area pb30">
        <strong class="col-lg-2 col-sm-2" style="line-height:50px;white-space: nowrap;align-items: center;display: flex;">ADVISED BY</strong>
        <ul class="col-lg-10 col-sm-10">
            <li><a href="https://www.nstc.gov.tw//" target="_blank"><img src="images/agencies/NSTC.png"></a></li>
        </ul>
    </div>
    <div class="sp2_area pb30">
        <strong class="col-lg-2 col-sm-2" style="line-height:50px;white-space: nowrap;align-items: center;display: flex;">DIAMOND SPONSORS</strong>
        <ul class="col-lg-10 col-sm-10">
    ...
    <div class="sp2_area pb30">
        <strong class="col-lg-2 col-sm-2" style="line-height:50px;white-space: nowrap;align-items: center;display: flex;">GOLD SPONSORS</strong>
        <ul class="col-lg-10 col-sm-10">
